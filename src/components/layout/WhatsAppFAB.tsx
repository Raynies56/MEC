  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      <motion.a
        ...
        className="relative flex items-center justify-center w-14 h-14 bg-[var(--success)] text-white rounded-full shadow-lg hover:shadow-xl hover:bg-[var(--success)]/90 transition-all duration-200 z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--success)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
      ...
      {/* Tooltip */}
      <div
        className="absolute right-full top-1/2 -translate-y-1/2 mr-4 bg-[var(--neutral-900)] text-white text-sm whitespace-nowrap px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none shadow-md"
        role="tooltip"
      >
        Escríbenos por WhatsApp
        <div className="absolute right-[-4px] top-1/2 -translate-y-1/2 transform rotate-45 w-2 h-2 bg-[var(--neutral-900)]" />
      </div>
    </div>
  );
}
